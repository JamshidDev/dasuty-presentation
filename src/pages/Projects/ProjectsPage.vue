...
<template>
  <UIPageContent>
    <div class="grid grid-cols-[repeat(auto-fill,minmax(400px,1fr))] gap-3">
      <div v-for="i in 11" :key="12" class="w-full bg-background-primary-mutable rounded-3xl p-2">
        <div class="rounded-2xl aspect-[2/1] overflow-hidden relative">
          <img
            src="https://mir-s3-cdn-cf.behance.net/projects/max_808/aacac176932859.Y3JvcCwxMDgzLDg0NywxMDQsMTMyNw.png"
        ...
        <div class="px-5 py-4 flex flex-col gap-3">
          ...
          <p class="font-medium text-text-icon-secondary1-mutable">
            Hamma ma'lumotlar bitta xaritada — real vaqtda nazorat va tahlil
          </p>
        </div>
